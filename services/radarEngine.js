...
async function runRadarAnalysis(input) {
  ...
  const summary =
    "This is a v1.1 placeholder procedural brief. The full Invention Radar pipeline will enrich this with legal, technical, and strategic guidance.";
